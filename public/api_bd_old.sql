...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 11 nov. 2025 à 10:08
...
--
-- Structure de la table `cabinet_type`
--
...
--
-- Structure de la table `email_address`
--
...
--
-- Structure de la table `lawyer_specialty`
--
...
--
-- Structure de la table `_stg_lawyer_csv`
--

CREATE TABLE `_stg_lawyer_csv` (
  `post_title` text DEFAULT NULL,
  `post_name` text DEFAULT NULL,
  `post_type` text DEFAULT NULL,
  `categories` text DEFAULT NULL,
  `tags` text DEFAULT NULL,
  `gd_place_tag` text DEFAULT NULL,
...
--
-- Déchargement des données de la table `_stg_lawyer_csv`
--

INSERT INTO `_stg_lawyer_csv` (`post_title`, `post_name`, `post_type`, `categories`, `tags`, `gd_place_tag`, `color`, `description`, `phone`, `email`, `adresse`, `icon`, `image`) VALUES
('post_title', 'post_name', 'post_type', 'categories', 'tags', 'gd_place_tag', 'color', 'description', 'phone', 'email', 'adresse', 'icon', 'image'),
('ALLALI Louis Marc', 'allali-louis-marc', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '05 06 33 73 47', 'allali-louismarc@yahoo.fr', 'Cocody Riviéra, M’badon', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('COULOUD AHOUTCHI Judith', 'couloud-ahoutchi-judith', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 03 95 19', 'Jucouloud712@gmail.com', 'Abidjan Cocody,13 rue Lepic, 1ère Villa Bosson', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('PAH POTEY Willys Franck', 'pah-potey-willys-franck', 'gd_place', '', '', '', '', '', '07 09 39 20 19', 'POTEYWILLYS@GMAIL.com', 'Cabinet SCP-MOSSO, OHIN Conseil & Associés, Abidjan Riviera golf, Cité Elias 1, Immeuble Makoré RDC, Appt 1701', '', ''),
('DIALLO Aïchata Epouse ADEGBIDI', 'diallo-aïchata-epouse-adegbidi', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 07 01 25 61', 'lavoielegale@gmail.com', '2 Plateau Angré,8ème tranche', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('ALOCO KOUASSI Arthur', 'aloco-kouassi-arthur', 'gd_place', '', '', '', '', '', '27 21 23 01 90', '', 'Treichville zone 3, 26, rue des carrossiers Immeuble Francisco 3éme étage', '', ''),
('COULIBALY Kikoun', 'coulibaly-kikoun', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 77 43 06 25', 'Kikounfigespro.c@gmail.com', 'Abidjan 2 Plateaux,7ème tranche, quartier zinsou, non loin de l’hôtel le verseau', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('DOMORAUD OPERI Sydney', 'domoraud-operi-sydney', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 48 37 77 73', '', 'ADNA LAW Firm, rue Sainte Marie Cocody Ambassade', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('SOUMAHORO Maba', 'soumahoro-maba', 'gd_place', '', '', '', '', '', '27 21 24 17 60', 'kadhysoumahoro@yahoo.fr', 'CIJ-Conseil, Cabinet de Me KRA Jacqueline Macory zone 4C, rue Pierre et Marie Curie', '', ''),
('CISSE Ladji', 'cisse-ladji', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 07 96 83 55', 'ladjiciss@yahoo.fr', '2 Plateau Aghien, immeuble Marie Djaha, rue L139, en face de la clinique Salpetrière', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('N’DA-EZOA Alain', 'n’da-ezoa-alain', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 93 13 35', 'alain_nda_ezoa@yahoo.fr', 'Cabinet NEC Consulting, Abidjan Cocody, Riviera les jardins', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('ENOKOU KANGAH Jean', 'enokou-kangah-jean', 'gd_place', '', '', '', '', '', '05 05 09 00 56', 'Jean.enokou@altioparteners.com', 'Bld de Marseille, Blétry immeuble Bleue cub, 3è étage porte A, face à la résidence Yacé', '', ''),
('ASSEMIEN N’Galet Ebaw Pierre', 'assemien-n’galet-ebaw-pierre', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '01 01 10 06 62', 'passemien@mk-conseil.net', 'Abidjan 2 Plateaux 7è tranche', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('BABAKAR Ka', 'babakar-ka', 'gd_place', 'Marcory', '', '', '#abc42d', 'Liste les conseillers juridiques de la commune de marcory.', '07 08 65 99 00', 'Kabab75@gmail.com', 'Abidjan, Marcory groupement foncier', '', ''),
('KOFFI Stephane', 'koffi-stephane', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '05 44 76 65 12', 'Stephanekoffi3@gmail.com', 'Cocody cité Prestige 1 Lot 31', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KONE Augustin Eloi', 'kone-augustin-eloi', 'gd_place', '', '', '', '', '', '07 08 39 01 91', '', 'SCPCJ Callaentis-Ekac « Associés », Abidjan riviera Palmeraie, non loin de Quick market, 2è étage P.6', '', ''),
('BAHIE SOKO Gabriel', 'bahie-soko-gabriel', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 08 19 06 77', 'g.cabinetbahieconseil@gmail.com', 'Cabinet BAHIE Conseil Abidjan Cocody riviera Palmeraie, rond-point ADO', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KOUDOU Micheline Rose', 'koudou-micheline-rose', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '05 06 46 86 24', 'micheline.koudou@gmail.com', 'Deloitte Côte d’Ivoire boulevard Hassan II, Abidjan Cocody', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KOBENAN Globaye Kwadjo', 'kobenan-globaye-kwadjo', 'gd_place', '', '', '', '', '', '05 05 95 12 32', 'Kleoncio2002@gmail.com', 'SCOGES Conseil (Zone 4 rue clément Ader)', '', ''),
('GNANDJI SAHONNE Silvain Boris', 'gnandji-sahonne-silvain-boris', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 08 90 49 87', 'g.sylvain@aphconseil.com', 'Cocody Faya, après le magasin bon prix', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('GNANMIEN KOUAKOU Jean', 'gnanmien-kouakou-jean', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '05 06 31 27 31', 'Jcgnanmien707@gmail.com', 'Cabinet PWC, Abidjan Cocody, Immeuble ITC, bâtiment D 3éme étage ; Angle rue booker washington, boulevard Hassan 2', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('BONGA ANGE Martial', 'bonga-ange-martial', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '27 22 46 69 71', 'bongamartial@gmail.com', 'Cocody Angré, 9è tranche, villa lot 477 ilot 22', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('DIOMANDE ABDOUL Ahmara', 'diomande-abdoul-ahmara', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 08 08 57 27', 'www.adiomande@d2a-conseils.com', 'Cocody 2 Plateaux vallon rue j75', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('COULIBALY FOUGNIGA', 'coulibaly-fougniga', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 64 81 07', 'coulibalyfougniga@yahoo.fr', 'Cocody , Cité des Arts en face de l’entrée principale de la cité BAD', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('BATI-BI HYRIET Joël Jean Silvere', 'bati-bi-hyriet-joël-jean-silvere', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 58 74 23 35', 'Jobatibi79@gmail.com', 'Abidjan Cocody Angré, zone Bessikoi, non loin du nouveau CHU, Résidence Harlène Anayah, 1er étage, Appt n°6', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('ABOA ANOH NARCISSE Anderson', 'aboa-anoh-narcisse-anderson', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '25 20 00 91 49', 'info@maitredeaboa.com', 'Plateau, immeuble les anciens combattants, 1er étage, alignement 1er Arrondissement et nouveau bâtiment du Trésor public', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KOUAME KOUADIO Antoine', 'kouame-kouadio-antoine', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 90 52 32', 'antoinekouame@eti-ci.com', 'Cocody cité des Arts villa n°1 face portail cité BAD', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('MEIZAN KOUADIO Dakoi', 'meizan-kouadio-dakoi', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '01 02 50 37 56', 'Kmiez2002@yahoo.fr', 'Cocody cité des Arts en face de l’entrée principale de la cité BAD', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('OUATTARA Kimbefo', 'ouattara-kimbefo', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 07 05 89 71', 'Ouattara_kimbefo@yahoo.fr', '2 Plateaux Vallons, 2è tranche, sortie rue des jardins, vers échangeur des 220 lgts, Immeuble contiguë à la station shell, 1er étage', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('BERE ELVIS Ahmed Wend-Nale', 'bere-elvis-ahmed-wend-nale', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 47 06 83 93', 'ahmedbere@gmail.com', 'Abidjan Cocody Faya', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('BOHUI HUGUES Gerard Kurtus', 'bohui-hugues-gerard-kurtus', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 48 33 63 68', 'Gerad.bohui@outlook.fr', 'Cocody Riviera', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('BOLOUZRAMON Goorenan Jocelyne-Andre Epouse ANO', 'bolouzramon-goorenan-jocelyne-andre-epouse-ano', 'gd_place', '', '', '', '', '', '07 58 42 19 19', 'anojocelyne@gmail.com', 'Yamoussokro', '', ''),
('DAGNOKO Karidja', 'dagnoko-karidja', 'gd_place', '', '', '', '', '', '07 59 05 17 71', 'Kdagnoko.cja@gmail.com', 'Riviéra Golf, les Caddies Tour Driver 1er étage Appartement 663', '', ''),
('DJEDJE PIERRE Claver', 'djedje-pierre-claver', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '27 22 59 92 70', 'pdjedje@c2a-ci.com', 'Cocody,2 plateaux vallon, 2è Tranche', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('DJIRE Ousmane', 'djire-ousmane', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '27 22 01 60 99', 'djire.ousmane@conseiljuridiqueci.org', 'Abidjan Cocody Angré Château, Résidence Willy porte E1', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('TRAORE MARIATOU Epouse DEMBELE', 'traore-mariatou-epouse-dembele', 'gd_place', '', '', '', '', '', '01 01 46 38 47', 'dtmariatou@yahoo.fr', 'Abidjan', '', ''),
('KOUAKOU Innocent', 'kouakou-innocent', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '01 01 31 81 80', 'Innocent.kouakou@gmail.com', 'Abidjan Cocody 2 Plateaux rue k64, en face de la pharmacie des Grâces', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KOUAKOU ASSEMIAN Faustin', 'kouakou-assemian-faustin', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '05 05 08 99 73', 'kfaustinassemian@yahoo.fr', 'Abidjan Cocody Vallon, rue des jardins, immeuble SAYEGH', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('FOFANA MOULOUKOU Souleymane', 'fofana-mouloukou-souleymane', 'gd_place', '', '', '', '', '', '07 07 49 82 82', 'sfofana@faoconseil.com', 'Cabinet Fiduciaire Afrique de l’Ouest immeuble SIMO Treichville zone 2', '', ''),
('DOUHOT DOMINIQUE Oswald', 'douhot-dominique-oswald', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '27 22 42 88 23', 'dominiqueoswald@yahoo.fr', 'Abidjan 2 Plateaux, carrefour Las Palmas', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('EHOZI EBA LARISSA Sandrine Muriel Stephanie', 'ehozi-eba-larissa-sandrine-muriel-stephanie', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '27 22 53 69 71', 'larissaehozi@gmail.com', 'Abidjan Cocody Angré, Pharmacie les Arcades', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('FOFANA MOHAMED Ibrahim Jamal', 'fofana-mohamed-ibrahim-jamal', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 48 35 54 83', 'jamal@jfconseils.com', 'Abidjan Cocody, Val doyen, rue A30 face à UCAO, cabinet Orrick RCI', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('SOHOU MONPOHO Landry Pacôme', 'sohou-monpoho-landry-pacôme', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '27 20 35 54 69', 'Icf.abidjan2@gmail.com', 'Cocody Angré, 7è tranche carrefour Bluetooth', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('SOULEYMANE Boundy', 'souleymane-boundy', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 47 23 06 50', 'Cesar.aloco@alocohein.com', 'Abidjan Plateau, immeuble Crozet sous-sol', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('ALOCO KOUAME KOUASSI Cesar', 'aloco-kouame-kouassi-cesar', 'gd_place', '', '', '', '', '', '27 21 23 01 90', 'Cesar.aloco@alocohein.com', 'Treichville zone 3,26, Rue des carrossiers immeuble Francisco 3ème étage', '', ''),
('BINI KOUASSI KOFFI Bienvenue', 'bini-kouassi-koffi-bienvenue', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 09 38 77 77', 'bkouassikof@gmail.com', 'Abidjan Cocody faya', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KOUAME AMANI Gilles-Hervé', 'kouame-amani-gilles-hervé', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 08 42 63 64', 'gilleskouame@gmail.com', 'Cabinet PWC, Abidjan Cocody, immeuble ITC, bât. D 3è étage Angle rue booker Washington, boulevard Hassan', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('COULIBALY Epouse CISSE Salimata', 'coulibaly-epouse-cisse-salimata', 'gd_place', 'Marcory', '', '', '#abc42d', 'Liste les conseillers juridiques de la commune de marcory.', '07 07 40 88 52', 'Cabinet2csconseiljuridique@gmail.com', 'Abidjan Marcory, zone 4', '', ''),
('BOUA DOUX Didier Charles', 'boua-doux-didier-charles', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 59 44 11 54', 'dbouadoux@asafo-rci.com', 'Abidjan, Cocody Val doyen, rue A30 face à UCAO, cabinet Orrick RCI', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('CATTANEO Fabienne', 'cattaneo-fabienne', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 49 26 62 26', 'florindacat@hotmail.fr', 'Abidjan Cocody, en face du siège PDCI immeuble SHAKESPEAR au 1er étage', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('GBAKAYORO Soumwerin Roger', 'gbakayoro-soumwerin-roger', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 08 14 13 51', 'gbakayoro.roger@gmail.com', 'Abidjan Plateau, immeuble Regus XXL', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('GBANE Salimata Epouse OUATTARA', 'gbane-salimata-epouse-ouattara', 'gd_place', '', '', '', '', '', '01 02 74 49 71', 'Gbane3salimata@gmail.com', 'Treichville rue 12, imm. New York Shopping 1er', '', ''),
('GENY BETA GNALY Honorat Jean Noël Daffot', 'geny-beta-gnaly-honorat-jean-noël-daffot', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '27 20 21 60 07', 'Ginaud2000@yahoo.fr', 'Abidjan Plateau, immeuble les harmonies 5ème étage, Appartement 62, Escalier M2', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KOUASSI KONAN Sosthene', 'kouassi-konan-sosthene', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 89 82 55 15', 'sothenekwassi@gmail.com', 'Abidjan cocody, en face du siège PDCI Immeuble SHAKESPEAR au 1er étage', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('TOURE LAMINE Dossé', 'toure-lamine-dossé', 'gd_place', 'Marcory', '', '', '#abc42d', 'Liste les conseillers juridiques de la commune de marcory.', '07 07 26 06 99', '', 'Abidjan Marcory Sicogi, Espace la Madone', '', ''),
('MEGALOU Eric Maxime', 'megalou-eric-maxime', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 08 30 30 03', 'eric.megalou@cdi-counsel.com', 'Plateau avenue Dr Crozet, immeuble Abidjan XL, 6ème étage, porte 610', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('GOHOGBEU TIA Vlery', 'gohogbeu-tia-vlery', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 08 40 40 49', 'g.tiavalery@gmail.com', 'Cocody Angré djibi, cité Arc-en-ciel', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('DOUMBIA Moussa', 'doumbia-moussa', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '05 05 48 16 46', 'c.doum@yahoo.fr', 'Abidjan Plateau', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('AHOUSSI Stephane Sylvain', 'ahoussi-stephane-sylvain', 'gd_place', '', '', '', '', '', '07 08 16 84 10', 'Stephane.ahoussi@gmail.com', 'Riviera Bonoumin Zinsou 2, rue 180 résidence Tonian, RDC porte A6', '', ''),
('AKA Desiré', 'aka-desiré', 'gd_place', '', '', '', '', '', '07 07 00 79 81', 'Desireaka01@gmail.com', 'Grand-Bassam, quartier Mockeyville lot 26 ilot 76C', '', ''),
('ASSAMOUA Yao Stanislas', 'assamoua-yao-stanislas', 'gd_place', '', '', '', '', '', '05 05 71 46 04', 'Assamoua.stanislas@gmail.com', 'Riviera Palmeraie rue Ministre immeuble PAX appartement C1', '', ''),
('YACE LEONCE Daniel Djeket', 'yace-leonce-daniel-djeket', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 59 77 77 77', 'l.yace@icloud.com', 'Abidjan Cocody Riviera Golf, immeuble SAMBA, RDC', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('ADOU GNOLBEYCES Igor', 'adou-gnolbeyces-igor', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '01 01 41 86 65', 'adouigor@yahoo.fr', 'Cocody Angré château, Résidence Maëlle 4è étage', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('ABOUDOU Sekou', 'aboudou-sekou', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '27 20 23 69 55', 'Aboudou.sekou@flyth.com', 'FlYTH Fiscal et Juridique. Abidjan Plateau, boulevard carde. Les Harmonies, 6è étage', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('TANO SERGE-OLIVIER N’da KOFFI', 'tano-serge-olivier-n’da-koffi', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 48 23 45 52', 'nksergeoli@gmail.com', 'Abidjan Plateau, Résidence du Banco', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KOFFI Mouhi', 'koffi-mouhi', 'gd_place', '', '', '', '', '', '07 08 30 12 70', 'mouhikoffi@gmail.com', 'Abidjan Angré', '', ''),
('AHOUSSI JUNIOR Frank Nicaise', 'ahoussi-junior-frank-nicaise', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 89 73 96 44', 'fahoussi@hotmail.fr', 'PKD conseil Abidjan Plateau, avenue Lamblin Résidence Eden 3è étage', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('BAYERON Michel Ahoun', 'bayeron-michel-ahoun', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 09 57 15 25', 'contact@cabinet-bayeron.com', 'Abidjan Cocody 2 Plateaux Angré, opération Bougainvilliers Appt.A02', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('SILUE Yaraba', 'silue-yaraba', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 47 07 70 30', 'ysiluey@gmail.com', 'Abidjan Cocody', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KOUYATE Valy', 'kouyate-valy', 'gd_place', '', '', '', '', '', '07 47 50 51 52', 'Kouyate.valy@yahoo.fr', 'Abidjan', '', ''),
('DIARRASSOUBA Adama Ben', 'diarrassouba-adama-ben', 'gd_place', 'Yopougon', '', '', '#ba6a1a', '', '07 08 71 43 73', 'adamaben@yahoo.fr', 'Abidjan Yopougon Assonvon, immeuble Koné, 2è étage, près de l’église Baptiste', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('FOFANA NATOGOMAN Marie Priscille Epouse YAO', 'fofana-natogoman-marie-priscille-epouse-yao', 'gd_place', '', '', '', '', '', '27 22 43 58 90', 'Yaomariepriscilla.mca@gmail.com', 'Cabinet SCP-MOSSO, OHIN Conseils & Associés, Abidjan Riviera Golf, Cité Elias 1, immeuble Makoré RDC. Appt 1701', '', ''),
('GUILE DABLOA Dagobert', 'guile-dabloa-dagobert', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '27 22 47 83 95', 'blebloa@gmail.com', 'Cocody route de Bingerville, Car.Abatta SIR, près de l’antenne de l’Université de Man, Imm, Résidence Holy Church, 1er Etage Porte 8', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('COULIBALY Awa Epouse COLLOT', 'coulibaly-awa-epouse-collot', 'gd_place', '', '', '', '', '', '07 08 09 20 41', 'Cabinetekac@gmail.com', 'SCPCJ Callentis-Ekac « Associés» Abidjan Riviéra Palmeraie, non loin de Quick Market, 2è étage, P.A6', '', ''),
('MOULARE Epouse ALOCO Isabelle Ouakou Constance', 'moulare-epouse-aloco-isabelle-ouakou-constance', 'gd_place', '', '', '', '', '', '07 47 71 71 71', 'isoualoco@gmail.com', 'Treichville, Rue des carrossiers zone 3', '', ''),
('DATTIE Jean Louis', 'dattie-jean-louis', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 07 90 00 90', 'jldattie@gmail.com', 'Cabinet Grant Thornton Tax & légal CI, Abidjan plateau rue du commerce, résidences Nabil 1er étage', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KATTIE ANDROUDOUX  Clement Yves Augustin', 'kattie-androudoux--clement-yves-augustin', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '05 05 28 22 22', 'Yves-auguste@hotmail.com', 'Cocody riviera 3, centre Saint Michel, rue E139', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KOFFO Lydie Sephora Epouse BAKAYOKO', 'koffo-lydie-sephora-epouse-bakayoko', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 14 49 99', 'koffosephora@yahoo.fr', 'Abidjan Cocody 7ème tranche', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KONE MOHAMED Yves Alexandre', 'kone-mohamed-yves-alexandre', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '27 20 32 76 26', 'Yvesalexandre1er@gmail.com', 'Plateau, rue du commerce, immeuble NASSAR et GAGGAR, au dessus de la pharmacie Mazuet 3è étage, porte A23', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KONE Issouf', 'kone-issouf', 'gd_place', '', '', '', '', '', '07 07 21 60 21', 'Koneissouf1954@gmail.com', 'Treichville, immeuble la Balance, 2è étage en face de la solibra', '', ''),
('COULIBALY Epouse KOUADIO Kafaga Yely Bintou', 'coulibaly-epouse-kouadio-kafaga-yely-bintou', 'gd_place', '', '', '', '', '', '27 20 23 69 55', 'Bintou.coulibaly-kouadio@flyth.com', 'FLYTH Fiscal et Juridique. Abidjan, Boulevard carde. Immeuble les Harmonies, 6è étage', '', ''),
('N’KLO Sylvie', 'n’klo-sylvie', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 07 99 48 00', 'Sylvieklo23@gmail.com', 'Plateau, Imm, les Anciens Combattants, 1er étage, alignement 1er Arrondissement et nouveau bâtiment du Trésor public', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('TOURE Samah Aïda', 'toure-samah-aïda', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 03 74 02', 'Samah53@hotmail.com', 'Abidjan Cocody, Saint Jean', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('SANAGO Massandjé Epouse BERTE', 'sanago-massandjé-epouse-berte', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 09 13 64 64', 'massibertsanogo@yahoo.fr', 'Abidjan, Cocody Faya, résidence HOPE ? non loin de l’église Catholique Saint PAUL des lauriers 9', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('SAYNI ASSOH Marie-Claire Epouse ASSOUMOU', 'sayni-assoh-marie-claire-epouse-assoumou', 'gd_place', '', '', '', '', '', '01 01 86 00 36', 'asmusayni@gmail.com', 'Riviéra Palmeraie', '', ''),
('AMAND Patricia Valerie Aimée', 'amand-patricia-valerie-aimée', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 57 53 17 33', 'p.aman@p2aconseils.com', 'Cabinet P2A,Abidjan 2 Plateaux Vallon, Carrefour Ambassade du Ghana, Immeuble Fougère, rue j14, bâtiment B23, 1er étage', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('AMADOU Koné', 'amadou-koné', 'gd_place', '', '', '', '', '', '27 21 24 56 82', 'kafolodjeamadoukone@gmail.com', 'Abidjan Treichville, immeuble la balance 2è étage', '', ''),
('KOUACOU AKA Innocent', 'kouacou-aka-innocent', 'gd_place', '', '', '', '', '', '25 22 00 42 63', 'bamadhcorporate@gmail.com', 'ABATTA, à côté de la SICTA', '', ''),
('KOUAME ERIC Lambert N’guessan', 'kouame-eric-lambert-n’guessan', 'gd_place', '', '', '', '', '', '07 08 02 50 38', 'eric.nguessan@ci.ey.com', 'FFA conseil, 5 Avenue Marchand, Pateau', '', ''),
('ASSALE ADJEI Charles', 'assale-adjei-charles', 'gd_place', '', '', '', '', '', '07 48 31 38 93', 'charlesassale@gmail.com', 'Abidjan, Feh Kessé route de Bingerville', '', ''),
('KOUAKOU ABEMAN Firmin', 'kouakou-abeman-firmin', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '05 06 29 20 00', 'Kouassi24firmin@gmail.com', 'Cocody 2 Plateaux, Boulevard des Martyres, résidence SICOGI latrille, près de la mosquée d’Aghien, bat N, 1er étage porte 161', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('YAPI Marcel', 'yapi-marcel', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 52 25 61', 'contact@amdgconseilsfiscaux.com', 'AMDG CONSEILS FISCAUX, Cocody Cité Sicogi, Saint Jean, immeuble GAUGUIN 3ème étage, Appt 40', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('MELAN AMOLY Marie Odile Epouse N’TAYE', 'melan-amoly-marie-odile-epouse-n’taye', 'gd_place', '', '', '', '', '', '07 09 17 04 77', 'melanamoly@yahoo.fr', 'Abidjan Treichville, Avenue Christiani immeuble Berger Diop', '', ''),
('MIANGNE MELLO Huberson Ares', 'miangne-mello-huberson-ares', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 09 60 75 25', 'harmelconseil@gmail.com', 'Cocody Angré, Star 9B, Villa 459', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('N’GUESSAN AYA Françoise-Xavière', 'n’guessan-aya-françoise-xavière', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 56 57 39', 'Nguessanfrancoise2007@yahoo.fr', 'Cocody riviéra golf', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('N’GUESSAN Lilianne Mauricine St LIN Eléonore', 'n’guessan-lilianne-mauricine-st-lin-eléonore', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 07 05 89 70', 'linguessan@gmail.com', 'Cabinet conseils Associés en Afrique C2A, 2Plateaux Vallon, 2è tranche, sortie rue des jardins vers échangeur des 220 Lts, imm. Contigë à la station shell, 1er étage', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('SOKOTY KOFFI Toussaint', 'sokoty-koffi-toussaint', 'gd_place', '', '', '', '', '', '07 89 55 21 64', 'Toussaint.sokoty@yahoo.fr', '', '', ''),
('SERY Marie Anne Epouse KURAYUM', 'sery-marie-anne-epouse-kurayum', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 70 15 82', 'marie.kurayum@gmail.com', 'Abidjan Cocody Palmeraie, Laurier 9', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('TIEBLEY Yves Didier', 'tiebley-yves-didier', 'gd_place', '', '', '', '', '', '05 06 37 20 71', 'tiebleyves@gmail.com', 'Abidjan', '', ''),
('WOGNIN AMAGOUA Jean Paul', 'wognin-amagoua-jean-paul', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 57 40 26', 'jeanpaulwognin@yahoo.fr', 'Cocody Riviera Palmeraie, Immeuble AL JAWAD, 3ème étage porte C8', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('ZOGBO BAYERE Ignace Désiré', 'zogbo-bayere-ignace-désiré', 'gd_place', '', '', '', '', '', '05 46 10 77 59', 'zogbod116@gmail.com', 'Koumassi, 6è Arrondissement, près des banques', '', ''),
('YEBOUE Brigitte', 'yeboue-brigitte', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '05 06 30 51 92', 'Brigitteyeboue2015@gmail.com', 'Abidjan Plateau, rue du commerce', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('YONAN Théodore', 'yonan-théodore', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '27 20 23 69 55', 'Theodore.yonan@flyth.com', 'FLYTH Fiscal et Juridique. Abidjan Plateau boulevard Carde, imm. Les Hamonies, 6è étage', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('YEO Marthe Epouse KARIDIOULA', 'yeo-marthe-epouse-karidioula', 'gd_place', '', '', '', '', '', '07 57 10 81 01', 'y.marthe0304@gmail.com', 'Bouké', '', ''),
('YACOUBA Coulibaly', 'yacouba-coulibaly', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '27 22 00 77 28', 'ycoulibaly@asafo-rci.com', 'Cocody Val. Doyen, rue A30, face UCAO', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('COULIBALY Bintou Epouse Ohin', 'coulibaly-bintou-epouse-ohin', 'gd_place', '', '', '', '', '', '05 05 83 85 62', '', 'Cabinet SCP-MOSSO, OHIN conseil & Associés, Abidjan Riviera Golf, cité Elias 1, Immeuble Makoré RDC Appt 1701', '', ''),
('ASSIRIFIX Philipe Auguste', 'assirifix-philipe-auguste', 'gd_place', '', '', '', '', '', '07 07 57 78 49', 'assirifix.philipe@gmail.com', 'Riviera 3', '', ''),
('EGUE ANDRE MARIE CHRISTIAN', 'egue-andre-marie-christian', 'gd_place', '', '', '', '', '', '07 08 58 80 94', 'cabconsegue@yahoo.fr', 'Riviera 3 attoban', '', ''),
('THIEMON Raphaël', 'thiemon-raphaël', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 08 97 77 72', 'Ccjf2019@yahoo.fr', '2 Plateaux Boulevard Latrille, \nCité Saint Jacques, Rue K 36, lot n° 419', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('N’DJESSAN Guy Léonard', 'n’djessan-guy-léonard', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '05 84 33 36 21', 'gdjessan@gmail.com', '2 Plateaux Boulevard Latrille,\nCité Saint Jacques, Rue K 36, lot n°419', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KABLAN Jean Junior', 'kablan-jean-junior', 'gd_place', '', '', '', '', '', '07 08 44 24 42', 'abgkablan@gmail.com', 'Treichville, avenue Christiani, rue & » barrée (Plazzard)', '', ''),
('KOFFI KABLAN DEGNAN Michel Benson', 'koffi-kablan-degnan-michel-benson', 'gd_place', '', '', '', '', '', '07 57 56 23 13', 'miange2010@yahoo.fr', 'Angré château, Rue des Amoatrins', '', ''),
('ANI GBAYERE IKA Raymond', 'ani-gbayere-ika-raymond', 'gd_place', '', '', '', '', '', '07 09 60 60 08', 'Any.raymond01@gmail.com', 'Riviera Golf 4, Immeuble Brandon & Mcain, Appt 3', '', ''),
('DOUBIRE Hien', 'doubire-hien', 'gd_place', '', '', '', '', '', '07 07 73 74 15', 'doubire.hien@alocohien.com', 'ZONE 3,26, Rue des Carrossiers, Imm. Francisco', '', ''),
('KONAN KOUADIO Etienne', 'konan-kouadio-etienne', 'gd_place', 'Yopougon', '', '', '#ba6a1a', '', '05 05 53 99 83', 'Konankouadioetienne@yahoo.fr', 'Abidjan Yopougon, face FIGAYO', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('OUATTARA Dougnimata Ahmed', 'ouattara-dougnimata-ahmed', 'gd_place', '', '', '', '', '', '27 21 24 56 82', 'Ouattara.ahmed@hotmail.com', 'Abidjan Treichville, Immeuble la balance, 2è étage', '', ''),
('KOUAKOU KOUAKOU Jérôme', 'kouakou-kouakou-jérôme', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '27 22 42 20 88', 'jeromekouakou@yahoo.fr', 'Abidjan Cocody Angré, Terminus 81/ 82, face NSIA Banque, rue des Aigles 1er étage porte A4', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('KOUADIO Yao Jacques Alphonse', 'kouadio-yao-jacques-alphonse', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 48 15 43 16', 'jkouadio@southinvestcab.com', 'Cocody 8ème tranche, rue ONOA SPA', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('COULIBALY Lazeni', 'coulibaly-lazeni', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 08 96 16 16', 'mariecoulibaly1971@gmail.com', 'Cocody 2Plateaux, face Pharmacie 7è tranche', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('ABEY AKUE Marius Ahouo', 'abey-akue-marius-ahouo', 'gd_place', '', '', '', '', '', '07 07 57 64 44', 'abeymarius0019@gmail.com', 'Abidjan Zone, 3 boulevard VGE, face au collège Moderne Autoroute, Immeuble ex Drocolor 2è Etage', '', ''),
('FADIGA Karamoko', 'fadiga-karamoko', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 33 07 32', 'kfadiga@asafo-rci.com', 'Abidjan Cocody, Val doyen, rue A30, face à l’UCAO', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('GOGOUA BAHI Charles', 'gogoua-bahi-charles', 'gd_place', '', '', '', '', '', '07 07 49 15 10', 'cgogoua@alltaxci.com', 'Riviera Golf, cité Elias1, Imm. Tiama, RDC appt 1503', '', ''),
('ALZOUMA Maïmouna Hélène Epouse TOURE', 'alzouma-maïmouna-hélène-epouse-toure', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 07 52 53 89', 'maimounalzouma@gmail.com', 'Cocody, Cité des Arts, 7è tranche, rue L169', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('WOGNIN Jean Claude', 'wognin-jean-claude', 'gd_place', '', '', '', '', '', '05 45 00 50 82', 'wognlntaxlaw@gmail.com', 'Angré 8è tranche, Immeuble SCI SAGED \n3è étage Appartement 305', '', ''),
('MYLONOYANNIS Patricia Aicha', 'mylonoyannis-patricia-aicha', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '27 22 41 60 53', 'dg@athena-conseil.com', 'Cocody Angré 7è tranche, lot 3694 ilot 301', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('MOSSO JULIEN Eymard', 'mosso-julien-eymard', 'gd_place', '', '', '', '', '', '07 07 58 05 67', 'mosso_julien@yahoo.fr', 'Cabinet SCP-MOSSO, OHIN Conseils & Associés. Abidjan Riviera Golf, Cité Elias 1, Immeuble Makoré RDC Appt 1701', '', ''),
('AMANI Kouassi', 'amani-kouassi', 'gd_place', '', '', '', '', '', '27 20 32 62 85', 'amaniconseil38@gmail.com', 'Cabinet SCP-MOSSO, OHIN Conseils & Associés. Abidjan Riviera Golf, Cité Elias 1, Immeuble Makoré RDC Appt 1701', '', ''),
('KOUAMELAN ECRA Serge Yves', 'kouamelan-ecra-serge-yves', 'gd_place', '', '', '', '', '', '07 07 20 02 72', 'ksergeyves@gmail.com', 'Cabinet SCP-MOSSO, OHIN Conseils & Associés. Abidjan Riviera Golf, Cité Elias 1, Immeuble Makoré RDC Appt 1701', '', ''),
('APHING KOUASSI Jean Daniel', 'aphing-kouassi-jean-daniel', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 77 43 00 88', 'Akjd69@gmail.com', 'Cocody 2 Plateaux Angré, Cité les Papayers, Villa 96', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('OUATTARA OUEKAN Hubert', 'ouattara-ouekan-hubert', 'gd_place', '', '', '', '', '', '07 07 96 96 98', 'Ouattara_hubert@yahoo.fr', 'Angré 7è tranche, face Groupe Scolaire Papillon', '', ''),
('GBALET Epouse CAMARA Françoise', 'gbalet-epouse-camara-françoise', 'gd_place', 'Plateau', '', '', '#1e73be', 'Liste les conseillers juridiques de la commune du plateau.', '07 07 36 15 23', 'fcamaragbalet@live.fr', 'Plateau, Cité Esculape', 'fa-solid fa-scale-balanced', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png'),
('ABOUGNAN BLEDJERO Alexis', 'abougnan-bledjero-alexis', 'gd_place', 'Marcory', '', '', '#abc42d', 'Liste les conseillers juridiques de la commune de marcory.', '07 07 08 47 24', 'Mardoche1@gmail.com', 'Abidjan Marcory, rue F 74 Dabou, derrière la Pharmacie du petit marché', '', ''),
('SIE KOFFI René', 'sie-koffi-rené', 'gd_place', 'Cocody', '', '', '#dd9933', 'Liste les conseillers juridiques de la commune de Cocody.', '07 08 08 78 78', 'renesiekoffi@etl-ci.com', 'Abidjan Cocody, Cité des arts, Rue de l’Impasse, Villa n°1', '', 'https://cncj-ci.ci/wp-content/uploads/2025/03/pin.png');
...
--
-- Index pour la table `cabinet_type`
--
ALTER TABLE `cabinet_type`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_CABTYPE_NAME` (`name`),
  ADD UNIQUE KEY `UNIQ_CABTYPE_SLUG` (`slug`);
...
--
-- Index pour la table `email_address`
--
ALTER TABLE `email_address`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_EMAIL_LAWYER` (`lawyer_id`),
  ADD KEY `IDX_EMAIL_CABINET` (`cabinet_id`);

--
-- Index pour la table `lawyer`
--
ALTER TABLE `lawyer`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_61EF7477989D9B62` (`slug`),
  ADD KEY `IDX_61EF7477D351EC` (`cabinet_id`),
  ADD KEY `IDX_LAWYER_ADDRESS` (`address_id`);

--
-- Index pour la table `lawyer_specialty`
--
ALTER TABLE `lawyer_specialty`
  ADD PRIMARY KEY (`lawyer_id`,`specialty_id`),
  ADD KEY `IDX_63117B554C19F89F` (`lawyer_id`),
  ADD KEY `IDX_63117B559A353316` (`specialty_id`);
...
ALTER TABLE `phone`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_PHONE_LAWYER` (`lawyer_id`),
  ADD KEY `IDX_PHONE_CABINET` (`cabinet_id`);
...
ALTER TABLE `specialty`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_E066A6EC989D9B62` (`slug`);
...
--
-- AUTO_INCREMENT pour la table `cabinet_type`
--
ALTER TABLE `cabinet_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `email_address`
--
ALTER TABLE `email_address`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=256;

--
-- AUTO_INCREMENT pour la table `lawyer`
--
ALTER TABLE `lawyer`
...
--
-- Contraintes pour la table `email_address`
--
ALTER TABLE `email_address`
  ADD CONSTRAINT `FK_EMAIL_CABINET` FOREIGN KEY (`cabinet_id`) REFERENCES `cabinet` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `FK_EMAIL_LAWYER` FOREIGN KEY (`lawyer_id`) REFERENCES `lawyer` (`id`) ON DELETE SET NULL;

--
-- Contraintes pour la table `lawyer`
--
ALTER TABLE `lawyer`
  ADD CONSTRAINT `FK_61EF7477D351EC` FOREIGN KEY (`cabinet_id`) REFERENCES `cabinet` (`id`),
  ADD CONSTRAINT `FK_LAWYER_ADDRESS` FOREIGN KEY (`address_id`) REFERENCES `address` (`id`);

--
-- Contraintes pour la table `lawyer_specialty`
--
ALTER TABLE `lawyer_specialty`
...
--
ALTER TABLE `phone`
  ADD CONSTRAINT `FK_PHONE_CABINET` FOREIGN KEY (`cabinet_id`) REFERENCES `cabinet` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `FK_PHONE_LAWYER` FOREIGN KEY (`lawyer_id`) REFERENCES `lawyer` (`id`) ON DELETE SET NULL;
COMMIT;
